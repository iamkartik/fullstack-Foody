...
function loadPlaces(map) {
    ...
    _axios2.default.get('/api/stores/near?lat=' + lat + '&lng=' + lng + '&limit=10').then(function (res) {
        var places = res.data;
...
function typeAhead(search) {
    ...
    searchInput.on('input', function () {
        ...
        _axios2.default.get('/api/search?q=' + this.value).then(function (res) {
            ...
            searchResult.innerHTML = _dompurify2.default.sanitize('<div class="search__result">No result found for ' + _this.value + '</div>');
        }).catch(function (err) {
            return console.error(err);
        });
    });
